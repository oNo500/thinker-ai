...
const CoreFeatureExperience: React.FC = () => {
  ...
  return (
    <div className='w-full bg-[#EFF1FF] flex flex-col justify-center items-center pb-[1000px]' >
      {/* 核心功能深度体验组件 */}
      <Title title='核心功能' subtitle='深度体验' description='每个功能都经过精心设计，为你的知识工作提供最佳体验' />
      <div className='flex flex-wrap w-[843px] justify-between gap-y-6 relative'>
        {
          FEATURE_LIST.map((item, index) => {
            return (
              <div key={index} onClick={() => setActive(index)} className={cn('w-[158px] h-[125px] rounded-[10px] flex flex-col justify-center items-center', {
                ...
                }} className='absolute flex flex-nowrap justify-between p-[61px] -bottom-6 translate-y-[100%] left-1/2 -translate-1/2 bg-[#fff] rounded-[20px] w-[1604px]'>
