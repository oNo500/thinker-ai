...
export const FreeButton = ({ className }: FreeButtonProps) => {
  return (
    <Button
      size="lg"
      className={cn(
        'h-[55px] rounded-full bg-gray-900 !px-[25px] py-4 text-xl font-medium text-white hover:bg-gray-800',
        className,
      )}
    >
      免费体验{' '}
